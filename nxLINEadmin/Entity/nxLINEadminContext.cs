...
{
    public partial class nxLINEadminContext : DbContext
    {
        public nxLINEadminContext()
        {
        }

        public nxLINEadminContext(DbContextOptions<nxLINEadminContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=devsv1.japaneast.cloudapp.azure.com;database=nxLINE;user=couponuser;password=M0dnwDnW;TrustServerCertificate=Yes");
            }
        }
